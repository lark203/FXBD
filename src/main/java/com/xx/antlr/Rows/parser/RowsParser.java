...
public class RowsParser extends Parser {
	...
	public static final int
		TAB=1, NL=2, STUFF=3;
	public static final int
		RULE_props = 0, RULE_file = 1, RULE_row = 2;
	...
	public static class PropsContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof RowsListener ) ((RowsListener)listener).enterProps(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof RowsListener ) ((RowsListener)listener).exitProps(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof RowsVisitor ) return ((RowsVisitor<? extends T>)visitor).visitProps(this);
