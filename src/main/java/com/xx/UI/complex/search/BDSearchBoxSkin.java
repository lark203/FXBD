...
public class BDSearchBoxSkin extends BDSkin<BDSearchBox> {
    ...
    public void initUI() {
        ...
        retractButton.setGraphic(Util.getImageView(20, BDIcon.PLAY_BACK));
    ...
    private void initLeftPane() {
        ...
        searchHistoryButton.setGraphic(Util.getImageView(20, BDIcon.SEARCH_HISTORY));
        ...
        searchCleanButton.setGraphic(Util.getImageView(20, BDIcon.CLOSE_SMALL));
        searchNewLineButton = new BDButton();
        searchNewLineButton.setSelectable(false);
        searchNewLineButton.setGraphic(Util.getImageView(20, BDIcon.NEW_LINE));
        searchNewLineButton.setTooltip(new Tooltip("新行  Ctrl+Shift+Enter"));
        searchCaseButton = new BDButton();
        searchCaseButton.setGraphic(Util.getImageView(20, BDIcon.MATCH_CASE));
        searchCaseButton.setTooltip(new Tooltip("区分大小写  Alt+C"));
        searchRegularExpressionButton = new BDButton();
        searchRegularExpressionButton.setGraphic(Util.getImageView(20, BDIcon.REGEX));
        ...
        replaceHistoryButton.setGraphic(Util.getImageView(20, BDIcon.SEARCH_HISTORY));
        ...
        replaceCleanButton.setGraphic(Util.getImageView(20, BDIcon.CLOSE_SMALL));
        replaceNewLineButton = new BDButton();
        replaceNewLineButton.setSelectable(false);
        replaceNewLineButton.setGraphic(Util.getImageView(20, BDIcon.NEW_LINE));
    ...
    private void initRightPane() {
        ...
        searchPreviousButton.setGraphic(Util.getImageView(20, BDIcon.UP));
        ...
        searchNextButton.setGraphic(Util.getImageView(20, BDIcon.DOWN));
        searchNextButton.setTooltip(new Tooltip("下一个匹配项  F3"));
        searchFilterButton = new BDButton();
        searchFilterButton.setSelectable(false);
        searchFilterButton.setGraphic(Util.getImageView(20, BDIcon.FILTER));
        ...
        searchMorButton.setGraphic(Util.getImageView(20, BDIcon.MORE_HORIZONTAL));
        searchCloseButton = new BDButton();
        searchCloseButton.setSelectable(false);
        searchCloseButton.getStyleClass().add("circle");
        searchCloseButton.setGraphic(Util.getImageView(20, BDIcon.CLOSE_SMALL));
